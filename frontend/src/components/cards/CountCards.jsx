...
const Unit = styled.div`font-size:14px;
                        margin-bottom:8px;`;
const Span = styled.div`margin-bottom:8px;
                        font-weight:500;
                        font-size: 16px
                        @media (max-width:600px){
                        font-size: 12px;
...
const Icon = styled.div`height:fit-content;
                        padding:8px;
                        display:flex;
                        align-items:center;
                        ...
                        color:${color};
                        `}`;
const Desc = styled.div`font-size:14px;
